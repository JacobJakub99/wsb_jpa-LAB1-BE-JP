...
public class PatientDaoImpl extends AbstractDao<PatientEntity, Long> implements PatientDao {
    ...
    @Override
    public List<PatientEntity> findPatientsWithInsurance(){
        TypedQuery<PatientEntity> query = entityManager.createQuery("SELECT patient FROM PatientEntity patient WHERE insurance LIKE true", PatientEntity.class);
        return query.getResultList();
    }
}
